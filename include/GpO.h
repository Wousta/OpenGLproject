...
//struct objeto {GLuint VAO;GLuint VBO;GLuint EBO;size_t element_count;};
...
bool cargar_modelo(const char *, std::vector<glm::vec3> &, std::vector<glm::vec2> &, std::vector<glm::vec3> &, std::vector<unsigned int> &);
